...
public class FRRecipes {
    ...
    private static void initInfusionRecipes(){
        ...
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Main.MOD_ID, "weather_stone"), new InfusionRecipe("WEATHER_STONE",
                ...
                "eternalLifeEssence", GHAST_TEAR, "runeAirB", new ItemStack(celestialNotes, 1, 0), "nitor", new ItemStack(celestialNotes, 1, 5), "runeAirB", GHAST_TEAR ));
        ...
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Main.MOD_ID, "dimensional_mirror"), new InfusionRecipe(
                "DIMENSIONAL_MIRROR",
        ...
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Main.MOD_ID, "advanced_mining_charm"),  new InfusionRecipe(
                "ADVANCED_MINING_CHARM",
        ...
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Main.MOD_ID, "ancient_aegis"), new InfusionRecipe("ANCIENT_AEGIS",
                ...
                "elvenDragonstone", PotionUtils.addPotionToItemStack(new ItemStack(Items.POTIONITEM), PotionTypes.STRONG_HEALING), "ingotGold", fabric, knockbackBelt /*belt*/, fabric, "ingotGold", PotionUtils.addPotionToItemStack(new ItemStack(Items.POTIONITEM), PotionTypes.STRONG_HEALING) ));

        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Main.MOD_ID, "dark_sun_ring"), new InfusionRecipe("DARK_SUN_RING",
                ...
                new ItemStack(baubles, 1, 5), //ring
        ...
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Main.MOD_ID, "deific_amulet"), new InfusionRecipe("DEIFIC_AMULET",
                ...
                new ItemStack(baubles, 1, 4), //amulet
        ...
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Main.MOD_ID, "chaos_core"), new InfusionRecipe("CHAOS_CORE",
        ...
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Main.MOD_ID, "paradox"), new InfusionRecipe("PARADOX",
        ...
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Main.MOD_ID, "shiny_stone"), new InfusionRecipe("SHINY_STONE",
        ...
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Main.MOD_ID, "oblivion_amulet"), new InfusionRecipe("OBLIVION_AMULET",
        ...
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Main.MOD_ID, "xp_tome"), new InfusionRecipe("EXPERIENCE_TOME",
        ...
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Main.MOD_ID, "arcanum"), new InfusionRecipe("FR_ARCANUM",
